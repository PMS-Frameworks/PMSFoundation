...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PMSPresentation.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/goeun1001/PMSPresentation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'goeun1001' => 'gogo8272@gmail.com' }
  s.source           = { :git => 'https://github.com/goeun1001/PMSPresentation.git', :tag => s.version.to_s }
